...
public class InputMoneyController {
	...
	public String inputMoneyPagePrint(@ModelAttribute("inputMoneyForm") InputMoneyForm form, Model model) {
		//ここから
		User user = new User(1, "axiz", "アクシズ", null, null, null, null, null, null);
	...
	private void setItemList(Model model) {
		...
		String usersId = String.valueOf(((User) session.getAttribute("user")).getUsersId());
		model.addAttribute("userItems", itemService.getItemsList(usersId, incomeOrOutgo));
	}
}