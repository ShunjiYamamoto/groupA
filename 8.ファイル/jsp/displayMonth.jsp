...
<body>
        ...
        <div id="header">
            ...
            <p><span class="headerBtn headerIcon label label-info"><a href = "displayMonth">戻る</a></span></p>
        </div>

    2020年
    <div class="border border-solid">
    <table class = "tableForDisplayMonth" id="tableFM" border="1" width="500" cellspacing="0" cellpading="5">
