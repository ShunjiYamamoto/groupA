...
<body>
    ...
    <p class="info">
        <span class="infobold">忘れ防止用通知の登録手順</span><br>
         1.Line Nofityにログインする<br> 2.マイページからトークンの発行を行う<br>
    ...
    <p>発行されたトークンを入力してください。
        ...
        <form:form action="line2" modelAttribute="test">
            <p>
                <form:input path="lineToken" value="${lineToken}" /><br> ${msg_lineToken}
            </p>
            ...
            <p>
                ...
                <form:radiobutton path="lineNoticeOn" value="Off" />オフ<br> ${msg_lineTime}
                <br>
            </p>
            <p>
