		...
		<div class="main">
			...
			<div class="errorMsg">
				...
				<form:form action="create" modelAttribute="test">
					<p><form:errors path="userId" cssStyle="color: red" /></p>
					<p><form:errors path="userName" cssStyle="color: red" /></p>
			...
			<form:form action="create" modelAttribute="test">
				...
				<p>ユーザーID：<form:input path="userId" /></p>
				<p>ユーザー名：<form:input path="userName" /></p>
				<p>パスワード：<form:password path="password" /></p>

				<form:button class="btn btn-primary" id="mainBtn">登録</form:button>
			</form:form>
