...
<body>
    <div class=”bg-opacity”>
        ...
        <div class="main">
            ...
            <div class="">
                <p><a href="inputMoney" class="btn btn-primary btn-lg" id="mainBtn">記入</a></p>
                <p><a href="displayMonth" class="btn btn-primary btn-lg" id="mainBtn">閲覧</a></p>
                <p><a href="setting" class="btn btn-primary btn-lg" id="mainBtn">設定</a></p>
